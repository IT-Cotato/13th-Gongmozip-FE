      ...
      {isLeaveConfirmationOpen ? (
        <div className="absolute inset-0 z-50 flex h-[844px] w-[390px] items-center justify-center gap-[10px] bg-[rgba(31,31,31,0.60)] px-8">
          <section
            ...
            aria-modal="true"
            className="mb-[19px] flex max-h-[400px] w-full flex-1 flex-col items-center rounded-2xl bg-white px-4 pb-4 pt-2 shadow-[0_53px_15px_0_rgba(0,0,0,0),0_34px_14px_0_rgba(0,0,0,0.01),0_19px_12px_0_rgba(0,0,0,0.05),0_9px_9px_0_rgba(0,0,0,0.09),0_2px_5px_0_rgba(0,0,0,0.10)]"
            role="dialog"
          >
